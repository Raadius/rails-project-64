...
JavaScript integration.',
  ...
  { title: 'Mastering PostgreSQL JSONB indexes for optimal performance',
    body:
      'PostgreSQL JSONB data type gives you schemaless flexibility without sacrificing query performance when
implemented correctly. This detailed guide covers advanced indexing strategies, GIN and GiST index types, and practical
examples of how to optimize complex JSON queries. Learn how to balance flexibility with performance in modern web
applications that require both structured and unstructured data storage patterns.',
    category: categories.sample }
].map do |attrs|
